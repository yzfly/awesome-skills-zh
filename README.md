...
| [**op7418/Humanizer-zh**](https://github.com/op7418/Humanizer-zh) | ![GitHub Repo stars](https://badgen.net/github/stars/op7418/Humanizer-zh) | [blader/humanizer](https://github.com/blader/humanizer) 的汉化版，专门消除中文文本中的 AI 生成痕迹；另有相关项目 [humanizer-zh-next](https://github.com/Hyacehila/humanizer-zh-next)：围绕 33 类常见中文写作模式进行编辑与审阅，并为论文、审稿回复和基金申请提供按需加载的学术模式，强调事实保真、作者语气与论断—证据边界。 |
