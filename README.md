...
| [**zenlee123/routerbase-agent-skills**](https://github.com/zenlee123/routerbase-agent-skills) | ![GitHub Repo stars](https://badgen.net/github/stars/zenlee123/routerbase-agent-skills) | 面向 [routerbase](https://routerbase.com/) 的 Agent Skills 合集，帮助智能体迁移 OpenAI-compatible API 调用、选择模型路由与 fallback，并构建图片、视频、音频生成工作流。 |
